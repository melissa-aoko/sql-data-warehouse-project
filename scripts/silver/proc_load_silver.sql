/*==============================================================
  ...
  the Bronze Layer into the Silver Layer of the data warehouse.
  ...
  - Truncates target tables before reload
  - Applies transformation and validation logic
  - Standardizes inconsistent source data
...
BEGIN
    ...
    /*==========================================================
      DECLARE VARIABLES
      Used for tracking execution time of loads
    ==========================================================*/
    ...
    BEGIN TRY
        ...
        -- Keep most recent customer record only
        WHERE flag_last = 1;
        ...
        SELECT
            ...
            -- End date = 1 day before next product start date
            CAST(
                LEAD(prd_start_dt)
        ...
        /*======================================================
          ...
          - Replace bad data with derived values
        ======================================================*/
        SET @start_time = GETDATE();
